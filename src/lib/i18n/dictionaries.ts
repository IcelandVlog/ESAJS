...
export const dictionaries = {
  bn: {
    ...
    "admins.hint": "প্রতি ব্যাচে সর্বোচ্চ {max} জন অ্যাডমিন রাখা যাবে। ব্যাচ অ্যাডমিন শুধু নিজের ব্যাচের শিক্ষার্থী (দেখা, যোগ, এডিট, অনুমোদন, মুছে ফেলা) ও রিইউনিয়ন পরিচালনা করতে পারবেন। নোটিশ, গ্যালারি ও অন্য অ্যাডমিন পরিচালনা শুধু মেইন অ্যাডমিন করতে পারবেন।",
    "admins.username": "ইউজারনেম",
    "admins.password": "পাসওয়ার্ড",
    "admins.passwordHint": "অন্তত ৬ অক্ষর, একটি বড় হাতের অক্ষর, একটি সংখ্যা ও একটি বিশেষ চিহ্ন। ইউজারনেম ও পাসওয়ার্ড অ্যাডমিন লগইন পেজে ব্যবহার হবে।",
    "admins.show": "দেখান",
    "admins.hide": "লুকান",
    "admins.create": "অ্যাডমিন তৈরি করুন",
  ...
  en: {
    ...
    "admins.hint": "Each batch can have up to {max} admins. A batch admin can manage only their own batch's students (view, add, edit, approve, delete) and reunions. Notices, gallery and managing other admins stay with the main admin.",
    "admins.username": "Username",
    "admins.password": "Password",
    "admins.passwordHint": "At least 6 characters with one uppercase letter, one number and one special character. They log in with this username and password on the admin login page.",
    "admins.show": "Show",
    "admins.hide": "Hide",
