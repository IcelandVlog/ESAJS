          ...
          <div className="relative max-w-4xl mx-auto px-4 sm:px-6 py-24 sm:py-32 text-center">
            ...
            <div className="flex flex-wrap items-center justify-center gap-4">
              <Link
                ...
                className="inline-flex items-center gap-2 rounded-full px-6 py-3 font-semibold text-white bg-gradient-to-r from-brand-blue to-blue-600 hover:opacity-90 transition-opacity shadow-lg shadow-black/30"
              >
                {t("hero.studentLogin")}
              </Link>
              <a
